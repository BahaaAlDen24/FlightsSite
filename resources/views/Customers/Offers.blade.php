                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-sharp bold uppercase">Offers Table</span>
                        </div>
                    </div>
                            ...
                            @if (isset($Objects))
                                @foreach ($Objects as $Object)
                                    <tr id="{{"tr" . $Object->id}}" class="odd gradeX">
                                        ...
                                        <td id="{{"DISCOUNTRATE" . $Object->id}}">{{$Object->DISCOUNTRATE}} %</td>
                            ...
                            <div class="modal-body" style="height:500px; overflow-y: auto;">
                                ...
                                <form method="post" enctype="multipart/form-data" id="ObjectsForm" name="ObjectsForm" class="form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Offer DISCOUNT RATE<span class="required">*</span></label>
                                            <div class="col-md-9">
                                                <div class="input-inline input-medium">
                                                    <input id="DISCOUNTRATE"  name="DISCOUNTRATE"type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-12 news-page blog-page">
                                                <div class="row">
                                                        ...
                                                        <div id="myCarousel" class="carousel image-carousel slide">
                                                            <div class="carousel-inner">
                                                                <div class="active item">
                                                                    <img id="Img1" src="{{asset('assets/DownloadedFiles/Offer/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="item">
                                                                    <img id="Img2" src="{{asset('assets/DownloadedFiles/Offer/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="item">
                                                                    <img id="Img3" src="{{asset('assets/DownloadedFiles/Offer/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="item">
                                                                    <img id="Img4" src="{{asset('assets/DownloadedFiles/Offer/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                            </div>
                                                            <!-- Carousel nav -->
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="top-news">
                                                            <a href="javascript:;" class="btn green"><span>Offer Name   </span><span id="ViewPageName"></span><i class="fa fa-music top-news-icon"></i></a>
                                                            <a href="javascript:;" class="btn yellow"><span>Offer DISCOUNT RATE  </span><span id="ViewPageDISCOUNTRATE"></span><i class="fa fa-book top-news-icon"></i></a>
    ...
    <script type="text/javascript">
            ...
            if (Mode == "New") {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var NewRow = '<tr id="tr' + data.id + '" class="odd gradeX">' +
                            ...
                            '              <td id="DISCOUNTRATE' + data.id + '">' + data.DISCOUNTRATE + ' %</td>' +
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $("#DISCOUNTRATE"+ data.id).html(data.DISCOUNTRATE + " %") ;
        ...
        function Update(id) {
            ...
            $.get('/Offer/' + id , function (data) {
                ...
                DISCOUNTRATE.value = MyData.DISCOUNTRATE ;

                $('#thumbnail1').append('<img src={{asset('assets/DownloadedFiles/Offer/')}}/' + id + '/IMGSRC1.jpg>') ;
                $('#thumbnail2').append('<img src={{asset('assets/DownloadedFiles/Offer/')}}/' + id + '/IMGSRC2.jpg>') ;
                $('#thumbnail3').append('<img src={{asset('assets/DownloadedFiles/Offer/')}}/' + id + '/IMGSRC3.jpg>') ;
                $('#thumbnail4').append('<img src={{asset('assets/DownloadedFiles/Offer/')}}/' + id + '/IMGSRC4.jpg>') ;
        ...
        function View(id){
            ...
            $.get('/Offer/' + id , function (data) {
                ...
                $("#ViewPageDISCOUNTRATE").text(MyData.DISCOUNTRATE) ;
                $("#ViewPageCreatedDate").text(MyData.CREATED_AT) ;
                $("#ViewPageUpdatedDate").text(MyData.UPDATED_AT) ;

                $("#Img1").attr('src','{{asset('assets/DownloadedFiles/Offer/')}}/' + id + '/IMGSRC1.jpg');
                $("#Img2").attr('src','{{asset('assets/DownloadedFiles/Offer/')}}/' + id + '/IMGSRC2.jpg');
                $("#Img3").attr('src','{{asset('assets/DownloadedFiles/Offer/')}}/' + id + '/IMGSRC3.jpg');
                $("#Img4").attr('src','{{asset('assets/DownloadedFiles/Offer/')}}/' + id + '/IMGSRC4.jpg');
