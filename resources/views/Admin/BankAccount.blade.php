                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-sharp bold uppercase">Bank Accounts</span>
                        </div>
                                            ...
                                            <div class="col-md-12 news-page blog-page">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="top-news">
                                                            <a href="javascript:;" class="btn green"><span>Bank Account Name   </span><span id="ViewPageName"></span><i class="fa fa-music top-news-icon"></i></a>
...
@section('pageJS')
    ...
    <script type="text/javascript">
        ...
        function Update(id) {
            ...
            $('#Loading').modal('show');
            $.get('/BankAccount/' + id , function (data) {
                debugger
