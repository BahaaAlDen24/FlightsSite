                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-sharp bold uppercase">Cities Table</span>
                        </div>
                                                ...
                                                <select class="form-control select2" name="COUNTRYID" id="COUNTRYID">
                                                    ...
                                                    @if (isset($Countries))
                                                        @foreach ($Countries as $Country)
                                                            <option value="{{$Country->id}}">{{$Country->ENAME}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-12 news-page blog-page">
                                                <div class="row">
                                                        ...
                                                        <div id="myCarousel" class="carousel image-carousel slide">
                                                            <div class="carousel-inner">
                                                                <div class="active item">
                                                                    <img id="Img1" src="{{asset('assets/DownloadedFiles/City/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="item">
                                                                    <img id="Img2" src="{{asset('assets/DownloadedFiles/City/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="item">
                                                                    <img id="Img3" src="{{asset('assets/DownloadedFiles/City/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="item">
                                                                    <img id="Img4" src="{{asset('assets/DownloadedFiles/City/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                            </div>
                                                            <!-- Carousel nav -->
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="top-news">
                                                            <a href="javascript:;" class="btn green"><span>City Name   </span><span id="ViewPageName"></span><i class="fa fa-music top-news-icon"></i></a>
                                                            <a href="javascript:;" class="btn yellow"><span>Country   </span><span id="ViewPageCountry"></span><i class="fa fa-book top-news-icon"></i></a>
    ...
    <script type="text/javascript">
        ...
        function Update(id) {
            ...
            $.get('/City/' + id , function (data) {
                ...
                $('#thumbnail3').append('<img src={{asset('assets/DownloadedFiles/City/')}}/' + id + '/IMGSRC3.jpg>') ;
                $('#thumbnail4').append('<img src={{asset('assets/DownloadedFiles/City/')}}/' + id + '/IMGSRC4.jpg>') ;
        ...
        function View(id){
            ...
            $.get('/City/' + id , function (data) {
                ...
                $("#ViewPageCountry").text(MyData.Country) ;
                $("#ViewPageCreatedDate").text(MyData.CREATED_AT) ;
                $("#ViewPageUpdatedDate").text(MyData.UPDATED_AT) ;

                $("#Img1").attr('src','{{asset('assets/DownloadedFiles/City/')}}/' + id + '/IMGSRC1.jpg');
                $("#Img2").attr('src','{{asset('assets/DownloadedFiles/City/')}}/' + id + '/IMGSRC2.jpg');
                $("#Img3").attr('src','{{asset('assets/DownloadedFiles/City/')}}/' + id + '/IMGSRC3.jpg');
                $("#Img4").attr('src','{{asset('assets/DownloadedFiles/City/')}}/' + id + '/IMGSRC4.jpg');
