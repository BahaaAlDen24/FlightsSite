                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-sharp bold uppercase">Banks Table</span>
                        </div>
                                            ...
                                            <div class="col-md-12 news-page blog-page">
                                                <div class="row">
                                                        ...
                                                        <div id="myCarousel" class="carousel image-carousel slide">
                                                            <div class="carousel-inner">
                                                                <div class="active item">
                                                                    <img id="Img1" src="{{asset('assets/DownloadedFiles/Bank/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="item">
                                                                    <img id="Img2" src="{{asset('assets/DownloadedFiles/Bank/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="item">
                                                                    <img id="Img3" src="{{asset('assets/DownloadedFiles/Bank/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="item">
                                                                    <img id="Img4" src="{{asset('assets/DownloadedFiles/Bank/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                            </div>
                                                            <!-- Carousel nav -->
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="top-news">
                                                            <a href="javascript:;" class="btn green"><span>Bank Name   </span><span id="ViewPageName"></span><i class="fa fa-music top-news-icon"></i></a>
    ...
    <script type="text/javascript">
        ...
        function Update(id) {
            ...
            $.get('/Bank/' + id , function (data) {
                ...
                $('#thumbnail1').append('<img src={{asset('assets/DownloadedFiles/Bank/')}}/' + id + '/IMGSRC1.jpg>') ;
                $('#thumbnail2').append('<img src={{asset('assets/DownloadedFiles/Bank/')}}/' + id + '/IMGSRC2.jpg>') ;
                $('#thumbnail3').append('<img src={{asset('assets/DownloadedFiles/Bank/')}}/' + id + '/IMGSRC3.jpg>') ;
                $('#thumbnail4').append('<img src={{asset('assets/DownloadedFiles/Bank/')}}/' + id + '/IMGSRC4.jpg>') ;
        ...
        function View(id){
            ...
            $.get('/Bank/' + id , function (data) {
                ...
                $("#Img1").attr('src','{{asset('assets/DownloadedFiles/Bank/')}}/' + id + '/IMGSRC1.jpg');
                $("#Img2").attr('src','{{asset('assets/DownloadedFiles/Bank/')}}/' + id + '/IMGSRC2.jpg');
                $("#Img3").attr('src','{{asset('assets/DownloadedFiles/Bank/')}}/' + id + '/IMGSRC3.jpg');
                $("#Img4").attr('src','{{asset('assets/DownloadedFiles/Bank/')}}/' + id + '/IMGSRC4.jpg');
