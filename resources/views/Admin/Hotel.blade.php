                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-sharp bold uppercase">Hotels Table</span>
                        </div>
                                ...
                                <form method="post" enctype="multipart/form-data" id="ObjectsForm" name="ObjectsForm" class="form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-control select2_category" name="CITYID" id="CITYID">
                                            ...
                                            <div class="col-md-12 news-page blog-page">
                                                <div class="row">
                                                        ...
                                                        <div id="myCarousel" class="carousel image-carousel slide">
                                                            <div class="carousel-inner">
                                                                <div class="active item">
                                                                    <img id="Img1" src="{{asset('assets/DownloadedFiles/Hotel/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="item">
                                                                    <img id="Img2" src="{{asset('assets/DownloadedFiles/Hotel/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="item">
                                                                    <img id="Img3" src="{{asset('assets/DownloadedFiles/Hotel/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                                <div class="item">
                                                                    <img id="Img4" src="{{asset('assets/DownloadedFiles/Hotel/37/') . "/IMGSRC1.jpg"}}" class="img-responsive" alt="">
                                                                </div>
                                                            </div>
                                                            <!-- Carousel nav -->
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="top-news">
                                                            <a href="javascript:;" class="btn green"><span>Hotel Name   </span><span id="ViewPageName"></span><i class="fa fa-music top-news-icon"></i></a>
    ...
    <script type="text/javascript">
        ...
        function Update(id) {
            ...
            $.get('/Hotel/' + id , function (data) {
                ...
                $("#CITYID").select2("val",MyData.CITYID);

                $('#thumbnail1').append('<img src={{asset('assets/DownloadedFiles/Hotel/')}}/' + id + '/IMGSRC1.jpg>') ;
                $('#thumbnail2').append('<img src={{asset('assets/DownloadedFiles/Hotel/')}}/' + id + '/IMGSRC2.jpg>') ;
                $('#thumbnail3').append('<img src={{asset('assets/DownloadedFiles/Hotel/')}}/' + id + '/IMGSRC3.jpg>') ;
                $('#thumbnail4').append('<img src={{asset('assets/DownloadedFiles/Hotel/')}}/' + id + '/IMGSRC4.jpg>') ;
        ...
        function View(id){
            ...
            $.get('/Hotel/' + id , function (data) {
                ...
                $("#Img1").attr('src','{{asset('assets/DownloadedFiles/Hotel/')}}/' + id + '/IMGSRC1.jpg');
                $("#Img2").attr('src','{{asset('assets/DownloadedFiles/Hotel/')}}/' + id + '/IMGSRC2.jpg');
                $("#Img3").attr('src','{{asset('assets/DownloadedFiles/Hotel/')}}/' + id + '/IMGSRC3.jpg');
                $("#Img4").attr('src','{{asset('assets/DownloadedFiles/Hotel/')}}/' + id + '/IMGSRC4.jpg');
